...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'synthetic_nadir_pointcloud_tf_publisher.py = elevation_mapping_cupy.scripts.synthetic_nadir_pointcloud_tf_publisher:main',
            'check_map_density.py = elevation_mapping_cupy.scripts.check_map_density:main',
        ],
    },
    data_files=[
